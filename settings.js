...
module.exports = {
SESSION_ID: process.env.SESSION_ID || ""3ZYTkRyS#sR7pAfiAyrBeGpHRSwf5TQmm2kmIaH0qo6xVsm-OVGk // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94769832532",
DEV: process.env.DEV || "94769832532",
